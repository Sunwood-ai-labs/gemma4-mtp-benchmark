...
LOG_PATH="${ROOT_DIR}/results/dflash/${STAMP}-contrast.log"

echo "DFlash repo: ${DFLASH_DIR}"
echo "Experiment:  ${ROOT_DIR}/scripts/dflash_contrast.py"
echo "Log:         ${LOG_PATH}"

.venv/bin/python "${ROOT_DIR}/scripts/dflash_contrast.py" "$@" 2>&1 | tee "${LOG_PATH}"
